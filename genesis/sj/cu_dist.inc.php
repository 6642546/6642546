...
<table border=1 rules="rows">
	...
	<tr><td>Grid size:</td><td><select name="gridsize"><option value="0.25">.25</option><option value="0.5">.50</option><option value="1">1.0</option><option value="2">2.0</option></select></select></td><td></td></tr>
