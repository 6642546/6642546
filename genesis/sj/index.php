...
<?php
	if ($_GET['data'] =='Search Job' || $_GET['data']==""){
	 require "genesis/sj/search.php";
	
	} else if ($_GET['data'] =='Copper Distribution Reports'){
	 echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' src='genesis/sj/cu_dist.inc.php?site=$site";
	 if ($lang) echo "&lang=$lang";
	 echo "' width='100%'></iframe></div>";
	} else if ($_GET['data'] =='Panel Utilization Reports'){
	 echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' src='genesis/sj/panel_util.inc.php?site=$site";
	 if ($lang) echo "&lang=$lang";
	 echo "' width='100%'></iframe></div>";
	} else if ($_GET['data'] =='Layers Report'){
	 echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' src='genesis/sj/layers_rpt.inc.php?site=$site";
	 if ($lang) echo "&lang=$lang";
	 echo "' width='100%'></iframe></div>";
	} 
?>