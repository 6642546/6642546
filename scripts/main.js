$(document).ready(function(){
	...
	$(window).resize(function() {
		if ($("#goTopBtn").css("display") == "block")
		{
			$("#goTopBtn").css("right",$(".container").offset().left-25);
		}
	});

	
	$("#goTopBtn").css("right",$(".container").offset().left-25);
	if (window.location.href =='http://cat03/feeweb/index.php' || window.location.href =='http://cat03/feeweb' || window.location.href =='http://cat03/feeweb/' || window.location.href =='http://feeweb-sj/' || window.location.href =='http://feeweb-us' || window.location.href=='http://feeweb-us/feeweb/index.php')
	{
		//check ip address here:
		var client_ip = $("#client_ip").html().substring(3);
		var ip_phase_2 = client_ip.substring(client_ip.indexOf('.')+1).substring(0,client_ip.substring(client_ip.indexOf('.')+1).indexOf('.'));
		var ip_action = $(".navlist .selected").html().toLowerCase();
		if (!isNaN(ip_phase_2) && ip_action =='home')
		{
			if ((ip_phase_2 == 65 || ip_phase_2 ==66)  && $('#default_site').html() !='HY')
			{
				if (ip_phase_2 == 65)
				{
					window.location.href='http://feeweb-hy/feeweb/index.php?lang=zh-cn';
				} else {
					window.location.href='http://feeweb-hy/feeweb/index.php?site=HZ&lang=zh-cn';
				}
			} else if ((ip_phase_2 == 120 || ip_phase_2 ==121 || ip_phase_2 ==67 || ip_phase_2 ==135)  && $('#default_site').html() !='GZ')
			{
					window.location.href='http://feeweb-gz/feeweb/index.php?lang=zh-cn';
			} else if ((ip_phase_2 == 1 || ip_phase_2 == 5 || ip_phase_2==31))
			{
				if (ip_phase_2 == 1)
				{
					window.location.href='http://feeweb-sj/feeweb/index.php';
				} else {
					//window.location.href='http://feeweb-us/feeweb/index.php?site=SJ';http://feeweb-sj/feeweb/index.php?site=SJ
					window.location.href='http://feeweb-sj/feeweb/index.php?site=SJ';
				}
			}
		}
	}
	...
	function() {
		...
		var action = $(".menu_gg").text().toLowerCase();
		if (!keyword)
		{
			alert('Please input keyword.');
			return;
		}
		window.location.href='index.php?site='+$("#site_text").html()+'&action='+action+'&keyword='+keyword;
    }
	);
	
	$("#outputxls").bind("click",
	function() {
		if ($("body").find("#outputxls_window").length==0)
		{
			$site = $("#site_text").html();
			$append_text = '<div id="outputxls_window">'
			$append_text +='<table id="outputxls_tbl" border="1" cellspacing=0 cellpadding=0 width="100%" style="border-collapse:collapse;"><tr><th colspan=2 style="padding-left:5px;">Measurement Unit</th></tr><tr><td><input type="radio" name="unit" id="unit" value="mils" checked/><label for="unit" style="padding-right:5px;">mil</label></td><td><input type="radio" name="unit" id="unit1" value="MM"/><label for="unit1" style="padding-right:5px;">mm</label></td></tr>';
			$append_text +='<tr><th colspan=2 style="padding-left:5px;">Laminate Description Field</th></tr><tr><td><input type="checkbox" name="core_family" id="core_family" checked/><label for="core_family" style="padding-right:5px;">Malt Family Name</label></td><td><input type="checkbox" name="copper_weight" id="copper_weight" checked/><label for="copper_weight" style="padding-right:5px;">Copper Weight</label></td></tr>';
			$append_text +='<tr><td><input type="checkbox" name="core_thk" id="core_thk" checked/><label for="core_thk" style="padding-right:5px;">Core Thickness</label></td><td><input type="checkbox" name="core_size" id="core_size"/><label for="core_size" style="padding-right:5px;">Panel Size</label></td></tr>';
			$append_text +='<tr><td><input type="checkbox" name="core_tg" id="core_tg"/><label for="core_tg" style="padding-right:5px;">TG</label></td><td><input type="checkbox" name="const" id="const"/><label for="const" style="padding-right:5px;">Core Construction</label></td></tr>';
			$append_text +='<tr><td><input type="checkbox" name="core_foil_tr" id="core_foil_tr"/><label for="core_foil_tr" style="padding-right:5px;">Foil Treatment</label></td><td>&nbsp;</td></tr>';
			$append_text +='<tr><th colspan=2 style="padding-left:5px;">Prepreg Description Field</th></tr><tr><td><input type="checkbox" name="pp_family" id="pp_family" checked/><label for="pp_family" style="padding-right:5px;">Malt Family Name</label></td><td><input type="checkbox" name="pp_tg" id="pp_tg"/><label for="pp_tg" style="padding-right:5px;">TG</label></td></tr>';
			$append_text +='<tr><td><input type="checkbox" name="glass" id="glass" checked/><label for="glass" style="padding-right:5px;">Glass Style</label></td><td><input type="checkbox" name="pp_size" id="pp_size"/><label for="pp_size" style="padding-right:5px;">Panel Size</label></td></tr>';
			$append_text +='<tr><td><input type="checkbox" name="resin" id="resin"/><label for="resin" style="padding-right:5px;">Resin %</label></td><td>&nbsp;</td></tr>';
			$append_text +='<tr><th colspan=2 style="padding-left:5px;">Thickness and DK Field</th></tr><tr><td><input type="checkbox" name="thk" id="thk" checked/><label for="thk" style="padding-right:5px;">Thickness</label></td><td><input type="checkbox" name="mdk" id="mdk" checked/><label for="mdk" style="padding-right:5px;">DK</label></td></tr><tr><td><input type="checkbox" name="cust_thk" id="cust_thk"/><label for="cust_thk" style="padding-right:5px;">Customer Req Thk</label></td><td><input type="checkbox" name="out_cu_thk" id="out_cu_thk"/><label for="out_cu_thk" style="padding-right:5px;">Outer Cu Thk</label></td></tr>';
			$append_text +='<tr><th colspan=2 style="padding-left:5px;">Others</th></tr><tr><td><input type="checkbox" name="imp_spacing" id="imp_spacing"/><label for="imp_spacing" style="padding-right:5px;">Imp Differential Spacing</label></td><td><input type="checkbox" name="dtable" id="dtable"/><label for="dtable" style="padding-right:5px;">Drill Table</label></td></tr><tr><td><input type="checkbox" name="samsung_format" id="samsung_format"/><label for="samsung_format" style="padding-right:5px;">Samsung Format</label></td><td>&nbsp;</td></tr>';
			
			$append_text +='</table></div>';
			$("body").append($append_text);
		}
		
		$('#outputxls_window').dialog({  
		         hide:'',
		         autoOpen:false, 
				 resizable:true, 
		         height:450,
		         width:350,  
		         modal:true,
		         title:'Stackup Report',   
		         buttons:{ 
				 	'OK':function(){  
		                outputxls();  
		             },  
				 	'Cancel':function(){  
		              $('#outputxls_window').dialog('close');  
		             }
	...
	function outputxls () {
		$('#outputxls_window').dialog('close');
		var site = $("#site_text").html();
		var server_name = $('#server_'+site).html();
		//server_name = 'localhost';
		var unit = $('#outputxls_tbl input:radio:checked').val();
		var to_url = '';
		if ($('#outputxls_tbl #samsung_format').attr('checked')) {
			to_url = 'http://'+server_name+'/feeweb/inplan/stackup_report/samsung_report.php?site='+site+'&job_name='+request('job_name');
		} else {
			to_url = 'http://'+server_name+'/feeweb/inplan/stackup_report/excel_report.php?site='+site+'&job_name='+request('job_name')+'&unit='+unit;
			if ($('#outputxls_tbl #core_family').attr('checked')) to_url +='&cf=1';
			if ($('#outputxls_tbl #copper_weight').attr('checked')) to_url +='&cw=1';
			if ($('#outputxls_tbl #core_thk').attr('checked')) to_url +='&ctk=1';
			if ($('#outputxls_tbl #core_size').attr('checked')) to_url +='&cs=1';
			if ($('#outputxls_tbl #core_tg').attr('checked')) to_url +='&ct=1';
			if ($('#outputxls_tbl #const').attr('checked')) to_url +='&cst=1';
			if ($('#outputxls_tbl #pp_family').attr('checked')) to_url +='&pf=1';
			if ($('#outputxls_tbl #pp_tg').attr('checked')) to_url +='&pt=1';
			if ($('#outputxls_tbl #glass').attr('checked')) to_url +='&gl=1';
			if ($('#outputxls_tbl #pp_size').attr('checked')) to_url +='&ps=1';
			if ($('#outputxls_tbl #resin').attr('checked')) to_url +='&rs=1';
			if ($('#outputxls_tbl #thk').attr('checked')) to_url +='&thk=1';
			if ($('#outputxls_tbl #mdk').attr('checked')) to_url +='&dk=1';
			if ($('#outputxls_tbl #core_foil_tr').attr('checked')) to_url +='&ft=1';
			if ($('#outputxls_tbl #cust_thk').attr('checked')) to_url +='&custk=1';
			if ($('#outputxls_tbl #out_cu_thk').attr('checked')) to_url +='&otk=1';
			if ($('#outputxls_tbl #imp_spacing').attr('checked')) to_url +='&ips=1';
			if ($('#outputxls_tbl #dtable').attr('checked')) to_url +='&dtb=1';
		}
		//alert(to_url);
		if ($("body").find("#stackup_report_frame").length==0) {
			$("body").find("#stackup_report_frame").remove();
		} 
		$('body').append('<iframe src="'+to_url+'" id="stackup_report_frame" height="0" width="0" style="display:none"></iframe>');
	}
	
	$(".change_site").bind("click",
	function() {
		//$('#change_site_window').window('open');
		if ($("body").find("#change_site_window").length==0)
		{
			$site = $("#site_text").html();
			$append_text = '<div id="change_site_window">'+
				'<dl>'+
				'	<dt><label for="color">Sites:</label><span id="action" style="display: none">'+$(".menu_gg").text().toLowerCase()+'</span></dt>'+
				'		<dd>'+
				'			<input type="radio" name="site" id="HY" value="HY"';
				if ($site=="HY") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="HY" style="padding-right:5px;">HY</label><input type="radio" name="site" id="HZ" value="HZ"';
				if ($site=="HZ") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="HZ" style="padding-right:5px;">HZ</label><input type="radio" name="site" id="GZ" value="GZ"';
				if ($site=="GZ") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="GZ" style="padding-right:5px;">GZ</label><input type="radio" name="site" id="ZS" value="ZS"';
				if ($site=="ZS") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="ZS" style="padding-right:5px;">ZS</label><input type="radio" name="site" id="SJ" value="SJ"';
				if ($site=="SJ") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="SJ" style="padding-right:5px;">SJ</label><input type="radio" name="site" id="FG" value="FG"';
				if ($site=="FG") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="FG" style="padding-right:5px;">FG</label><input type="radio" name="site" id="MI" value="MI"';
				if ($site=="MI") $append_text = $append_text + ' checked = "true"';
				$append_text = $append_text + '/><label for="MI" style="padding-right:5px;">MI</label></dd></dl></div>';

			$("body").append($append_text);
		}
		
		$('#change_site_window').dialog({  
		         hide:'',
		         autoOpen:false, 
				 resizable:true, 
		         height:187,
		         ...
		         buttons:{ 
				 	...
				 	'Cancel':function(){  
		              $('#change_site_window').dialog('close');  
		             }
		  ...
		  $('#change_site_window').dialog('open');

		
    });
	
	//upload file dialog
	$("#p_upload_btn").live("click",
	function() {
		if ($("body").find("#p_upload_file_window").length==0)
		{
			$site = $("#site_text").html();
			var $year = $("#year").val();
			var $week = $("#week").val();

			$append_text = '<div id="p_upload_file_window">'+
						   '<table><tr><td>Site:</td><td><select style="width:100px;" id="p_site"><option value="HY"';
			if ($site == 'HY') {
				$append_text +=' selected';
			}
			$append_text +='>HY</option><option value="GZ"';
			if ($site == 'GZ') {
				$append_text +=' selected';
			}
			$append_text +='>GZ</option><option value="ZS"';
			if ($site == 'ZS') {
				$append_text +=' selected';
			}
			$append_text +='>ZS</option><option value="FG"';
			if ($site == 'FG') {
				$append_text +=' selected';
			}
			$append_text +='>FG</option><option value="SJ"';
			if ($site == 'SJ') {
				$append_text +=' selected';
			}
			$append_text +='>SJ</option><option value="MI"';
			if ($site == 'MI') {
				$append_text +=' selected';
			}
			$append_text +='>MI</option></select></td></tr>';
				$append_text +='<tr><td>Year:</td><td><select style="width:100px;" id="p_year"><option value="2012"';
				if ($year == 2012) {
					$append_text +=' selected';
				}
				$append_text +='>2012</option><option value="2013"';
				if ($year == 2013) {
					$append_text +=' selected';
				}
				$append_text +='>2013</option><option value="2014"';
				if ($year == 2014) {
					$append_text +=' selected';
				}
				$append_text +='>2014</option><option value="2015"';
				if ($year == 2015) {
					$append_text +=' selected';
				}
				$append_text +='>2015</option></select></td></tr>';		   
				$append_text +='<tr><td>Week:</td><td><select style="width:100px;" id="p_week">';
				for (var i=1;i<=52;i++) {
					$append_text +='<option value="'+i+'"';
					if ($week == i) {
						$append_text +=' selected';
					}
					$append_text +='>'+i+'</option>';
				}
				$append_text +='</select></td></tr>';
				$append_text +='<tr><td>Report:</td><td><input type="button" id="p_upload_button" value="Browser..."></td></tr>';
				$append_text +='</table></div>';

			$("body").append($append_text);
		}
		
		$('#p_upload_file_window').dialog({  
		         hide:'',
		         autoOpen:false, 
				 resizable:true, 
		         height:257,
		         width:550,  
		         modal:true,
		         title:'Upload Productivity Report...',   
		         buttons:{ 
				 	'OK':function(){  
						submit_upload_file();
		                $('#p_file').remove();
						$('#p_upload_file_window').dialog('close'); 
		  ...
		  $('#p_upload_file_window').dialog('open');
		  
		  var button = $('#p_upload_button');
				var recordId = 0;		
				var year = $("#p_year").val();
				var site = $("#p_site").val();
				var fileType = "ppt"; 
				new AjaxUpload(button,{
					action: 'productivity/upload.php?year='+year+'&site='+site,
							/*data:{
							...
							onSubmit : function(file, ext){
									...
									if(varbj.success== true)
											button.val('Browse...');
											button.hide();
											button.parent().prepend('<span id="p_file">'+file+'</span>&nbsp;<input type="button" value="Delete" id="p_del_file" file_name="'+file+'">');                  
									}
				});
		
    });
	
	$("#p_del_file").live('click',function(){
						var file = $(this).attr("file_name");
						var site = $("#p_site").val();
						var year = $("#p_year").val();
						$.ajax({
						   type: "GET",
						   url: 'productivity/delFile.php?file='+file+'&site='+site+'&year='+year,
						   dataType: "json", 
						   success: function(msg){
							 if (msg.success == true) { 
								$("#p_file").remove();
								$("#p_del_file").remove();
								$('#p_upload_button').show();
							 } else {
								alert(msg.message);
							 }
	...
	$(".p_delete_db_file").live('click',function(){
						...
						if (confirm('Are you sure want to delete this report?')) {
								$.ajax({
							   type: "GET",
							   url: 'productivity/delDbFile.php?id='+id+'&file='+file+'&year='+year+'&site='+site,
							   dataType: "json", 
							   success: function(msg){
								 if (msg.success == true) { 
	...
	function submit_upload_file () {
				...
				var week = $("#p_week").val();
				var site = $("#p_site").val();
				var file = $("#p_file").html();
				$.ajax({
						   type: "GET",
						   url: 'productivity/save.php?year='+year+'&week='+week+'&site='+site+'&file='+file,
						   dataType: "json", 
						   success: function(msg){
							 if (msg.success == true) { 
								location.reload();
	...
	$("#p_search_btn").live('click',function() {
		var year = $("#year").val();
		var week = $("#week").val();
		var to_url = window.location.href='index.php?site='+$("#site_text").html()+'&action=productivity&year='+year+'&week='+week;
		if ($("#lang_code").html() == 'zh-cn')
		{
			to_url = to_url;
		} else {
			to_url = 'index.php?site='+$("#site_text").html()+'&action=productivity&lang=zh-cn&year='+year+'&week='+week;
		}
		window.location.href = to_url;
	});
	$("#ul_search_btn").live('click',function() {
		var dbase = $("#dbase").val();
		var ul_site = $("#ul_site").val();
		var type = $("#type").val();
		var to_url = window.location.href='index.php?site='+$("#site_text").html()+'&action=ul&dbase='+dbase+'&ul_site='+ul_site+'&type='+type;
		if ($("#lang_code").html() == 'zh-cn')
		{
			to_url = to_url + '&lang=zh-cn';
		} 
		window.location.href = to_url;
	});
	
	$("#ul_insert_btn").live('click',function() {
		var dbase = $("#dbase").val();
		var ul_site = $("#ul_site").val();
		var type = $("#type").val();
		var to_url = window.location.href='index.php?site='+$("#site_text").html()+'&action=ul&dbase='+dbase+'&ul_site='+ul_site+'&type='+type;
		...
		to_url = to_url + '&data=insert';
		window.location.href = to_url;
	});
	
	$("#ul_download_btn").live('click',function() {
		var site = $("#ul_site").val();
		var server_name = $('#server_'+site).html();
		//server_name = 'localhost';
		var to_url = 'http://'+server_name+'/feeweb/ul/download.php?ul_site='+site+'&dbase='+$("#dbase").val();
		$('body').append('<iframe src="'+to_url+'" id="ul_frame" height="0" width="0" style="display:none"></iframe>');
	});
});

$(".change_lang").live("click",
	function() {
		//var server_name = $('#server_'+$("#site_text").html()).html();
		var to_url = window.location.href='index.php?site='+$("#site_text").html()+'&action='+$(".navlist .selected").html().toLowerCase();
		if ($("#lang_code").html() == 'zh-cn')
		{
			to_url = to_url;
		} else {
			to_url = 'index.php?site='+$("#site_text").html()+'&action='+$(".navlist .selected").html().toLowerCase()+'&lang=zh-cn';
		}

		if ((request('action')=='inplan' ||request('action')=='tq')  && request('job_name')!='')
		{
			to_url = to_url + '&job_name=' + request('job_name') + '&data='+ request('data');
			if ( request('tq_pn') !='')
			{
				to_url = to_url + '&tq_pn='+request('tq_pn');
			}
		} else if (request('action')=='specification' && request('spec_name')!='')
		{
			to_url = to_url + '&spec_name=' + request('spec_name');
		} else if (request('action')=='genesis')
		{
			to_url = to_url + '&data='+ request('data');
		}
		if (request('process') !='')
		{
			to_url = to_url + '&process='+request('process');
		}
...
function close_change_site(){
	$('#change_site_window').dialog('close');  
}

function change_this_site(){
	$('#change_site_window').dialog('close');
	var action = '';
	if ($(".navlist .selected").length) {
		action = $(".navlist .selected").html().toLowerCase();
	} else {
		action = 'home';
	}
	var server_name = $('#server_'+$("#change_site_window :radio:checked").val()).html();
	var to_url = 'http://'+server_name+'/feeweb/index.php?site='+$("#change_site_window :radio:checked").val()+'&action='+action;
...
$(".searchaction").live("click",
	function() {
		var search_text = $.trim($("#searchinput").val());
		if (search_text == "- Quick Search -" || search_text == '- �������� -' || search_text == '' )
		{
			return;
		}
		var action = $(".navlist .selected").html().toLowerCase();
		
		$.ajax({ 
						type: "POST", 
						url: "check_pn.php?site="+$("#site_text").html(), 
						data:{action:action,kw:search_text},
						dataType: "json", 
						success: function(msg) { 
							var Result = msg.success;
							if (Result == false) {
							   var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+request('data')+'&kw='+search_text;
								if (request('lang') == 'zh-cn')
								{
									to_url = to_url + "&lang=zh-cn";
								}
							...
							if (Result == true) {
								if (action == 'tq')
								{
									var to_url = 'index.php?site='+$("#site_text").html()+'&action=tq'+'&data=TQ&tq_pn=yes'+'&job_name='+msg.message;
								} else {
									var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+request('data')+'&job_name='+msg.message;
...
$(".home_searchaction").live("click",
	function() {
		var search_text = $.trim($("#home_searchinput").val());
		var search_area = $("#search_area :radio:checked").val();
		if (search_text == "- Quick Search -" || search_text == '- �������� -' || search_text == '' )
		{
			return;
		}
		...
		if (search_area =='Current Site')
		{
			$.ajax({ 
						...
						success: function(msg) { 
							...
							if (Result == false) {
								if (action == 'tq')
								{
									var to_url = 'index.php?site='+$("#site_text").html()+'&action=tq'+'&data=TQ'+'&kw='+search_text;
								}  
								else {
									var rq_data = request('data');
									   if (rq_data == '')
									   {
										   rq_data = 'Job Attributes';
									   }
									   var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+rq_data+'&kw='+search_text;
								}
								if (request('lang') == 'zh-cn')
								{
									to_url = to_url + "&lang=zh-cn";
							...
							if (Result == true) {
								var rq_data = request('data');
								   ...
								   if (action == 'tq')
									...
									{
										var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+rq_data+'&spec_name='+msg.message;
									} 
									else {
										var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+rq_data+'&job_name='+msg.message;
										
									}
									//var to_url = 'index.php?site='+$("#site_text").html()+'&action='+action+'&data='+rq_data+'&'+_name+'='+msg.message;
									if (request('lang') == 'zh-cn')
									{
										to_url = to_url + "&lang=zh-cn";
									}
			...
			if (request('lang') == 'zh-cn')
			{
				window.location.href= 'index.php?site='+$("#site_text").html()+'&global_kw='+search_text + '&search_area='+action+ "&lang=zh-cn";
			} else {
				window.location.href= 'index.php?site='+$("#site_text").html()+'&global_kw='+search_text + '&search_area='+action;
			}
...
$("#outputpdf").live("click",
	function() {
	var url_data = '';
	var type ='';
	var url='';
	var site_dir ='';
	if ($("#site_text").html() == 'HY' || $("#site_text").html() == 'HZ')
	{
		site_dir = 'hy';
	} else if ($("#site_text").html() == 'FG' || $("#site_text").html() == 'SJ' || $("#site_text").html() == 'MI')
	{
		site_dir = 'allsites';
	} else if ($("#site_text").html() == 'GZ' || $("#site_text").html() == 'ZS')
	{
		site_dir = 'gz';
	}

	if (request('data') == 'Cam Instruction'){
		url_data = 'caminstructions.php';	
		type = 'memo';
	} else if (request('data') == 'Stackup')
	{
		url_data = 'stackup.php';	
		type = 'stackup';
	}  else if (request('data') == 'Traveller Routing')
	{
		url_data = 'traveler.php';	
		type = 'traveler';
	} else if (request('data') == 'Drill Table')
	{
		url_data = 'drill.php';	
		type = 'drill';
	} else if (request('data') == 'Tool Table')
	{
		url_data = 'tool.php';	
		type = 'tool';
	} else if (request('data') == 'Sheet Cutting')
	{
		url_data = 'sheet_cutting.php';	
		type = 'sheet_cutting';
	} else if (request('data') == 'Job History')
	{
		url_data = 'showjobhistory.php';	
		type = 'jobhistory';
	} else if (request('data') == 'Job Rev Compare')
	{
		url_data = 'Job_Rev_Compare.php';	
	}
	...
	url = 'http://'+$("#server_"+$("#site_text").html()).html()+'/feeweb/inplan/'+site_dir+'/'+url_data+'?site='+$("#site_text").html()+'&job_name='+request('job_name')+'&html2pdf=true'+process;
	if (request('data') == 'Stackup')
	{
		if (request('corerd')!='')
		{
			url += "&corerd=checked";
		...
		if (request('t_type')!='')
		{
			url += "&t_type="+request('t_type');
		}
		if (request('t_manu')!='')
		{
			url += "&t_manu="+request('t_manu');
		}
		if (request('t_revision')!='')
		{
			url += "&t_revision="+request('t_revision');
		}
		
		if (request('revision_1')!='')
		{
			url += "&revision_1="+request('revision_1');
		}
		if (request('revision_2')!='')
		{
			url += "&revision_2="+request('revision_2');
		}
		if (request('second_job')!='')
		{
			url += "&second_job="+request('second_job');
		}
		
		if (request('job_rev_2')!='')
		{
			url += "&job_rev_2="+request('job_rev_2');
		}
		if (request('c_type')!='')
		{
			url += "&c_type="+request('c_type');
		}


	if (url_data !='')
	{
		//alert('http://'+$("#server_"+$("#site_text").html()).html()+'/feeweb/inplan/hy/'+url_data+'?site='+$("#site_text").html()+'&job_name='+request('job_name')+'&html2pdf=true');
		$('body').mask("Creating PDF file, please wait...");
		$.ajax({ 
				type: "POST", 
				url: "inplan/html2pdf.php",
				data:{url:url,part_number:request('job_name'),type:type,site:$("#site_text").html()},
				dataType: "json", 
				success: function(msg) { 
					var Result = msg.success;
					if (Result == false) {
						...
						if (Result == true) {
							$('body').unmask();
							window.open('inplan/temp/'+request('job_name')+'-'+type+'.pdf');
							return true;
							}
				} 
		});
...
{    
    ...
    if(!isIE)
    {
        if(window.innerHeight > footerHeight)
            document.getElementById('ContentContainer').style.minHeight =  (document.documentElement.scrollHeight+80-footerHeight)+'px';
    }
    else
    {
            if(isIE6)
...
(function($){
	...
	$.addFlex = function(t,options)
	{
		...
		p = $.extend({
			 ...
			 showZero: true,
			 selectedCol: false,
			 pagestat: 'Dispaly {from} to  {to} items; Total  {total} items.',
			 procmsg: 'Processing, please wait ...',
			 query: '',
			 qtype: '',
			 nomsg: 'No result to display',
		...
		//pFirst_empty��pPrev_empty��pNext_empty��pLast_empty
		...
		var g = {
			...
			$('thead tr:first th:visible',this.hDiv).each
				(
			 	function ()
					...
					$('div:eq('+n+')',g.cDrag).css({'height':25+'px'}); //  Only heard can be drag
			...
			addData: function (data) { //parse data
				...
				if(data.error){
					jAlert(data.message, "Error Message");
				}
				if (p.preProcess)
...
//					if(p.filter){
//						ZZtips.attachTip(t.id,"no result��please try it again��");
//					}
					$(g.messDiv).show();
				} else {
					//ZZtips.detach(t.id);
							 	...
							 	function ()
									{
							 		...
							 		if("checkCol" == $(this).attr('abbr')){
										...
										if(p.colModel[idx].render)
										{
											if (p.colModel[idx].showTitle) {//title
												if (!p.colModel[idx].ingoreRender) {//
...
//					}
				...
				if( typeof(p.sortorder)== 'undefined'){
					...
					var filterStr = p.keyFilter ? encodeURIComponent(p.keyFilter) : '{}';
					var param = 'p0=' +  filterStr
								+'&page=' + (parseInt(p.newp))
							    + '&rows=' + p.rp
								+ '&query=' + encodeURIComponent(p.query)
								+ '&qtype=' + p.qtype
								+ '&sort='+p.sortname+(p.sortname ==""?"":" ")+p.sortorder; 
						...
						function ()
							{
								if((this.previousElementSibling != null && this.nextElementSibling == null) || (this.previousSibling != null && this.nextSibling == null)){
									...
									if (p.sortname==$(pth).attr('abbr')&&p.sortname) 
									 ...
									 $(tdDiv).css({textAlign:('checkCol'==pth.abbr?'left':pth.align),width: $('div:first',pth)[0].style.width});
									...
									var rowData = new Object();    
									 $.each($(this).find('div'),function(i){
										 if (p.checkBoxSelect)
										 {
											if (i>0)
											{
												$(rowData).data(p.colModel[i-1].name,$(this).text()); 
											}
										 } else $(rowData).data(p.colModel[i].name,$(this).text()); 
			...
			for (i=0;i<p.colModel.length;i++)
				{
					...
					if (cm.width) {
						if(p.widthPercent){
							if(!cm.hide){
								if($('.M-listRegion').attr('offsetTop') > 0){//
...
//							$(th).css('padding-left','2px');
		...
		$(g.messDiv).html("No results found.");
		$(g.messDiv).hide();
		$(t).before(g.messDiv);
			 	...
			 	function ()
					...
					//
						if ($(this).attr('abbr'))
					     ...
					     //
						 if (!this.hide ) $(thdiv).css({textAlign:'left', width: this.width + 'px'});
...
//			p.pages = Math.ceil(p.total/p.rp);
		...
		$(g.bDiv).after(g.pDiv);
		var html = ' <div class="pGroup"> <div id="pFirstDiv" class="pFirst_empty pButton"><span></span></div><div id="pPrevDiv" class="pPrev_empty pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><div style="padding-top:1px;_padding-top:3px;">Page&nbsp;&nbsp;<span class="pcontrol"><input type="text" size="4" value="1" style="height:13;font-size:12px"/> / <span> 1 </span></span></div></div> <div class="btnseparator"></div> <div class="pGroup"> <div id="pNextDiv" class="pNext_empty pButton"><span></span></div><div id="pLastDiv" class="pLast_empty pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"> <div class="pReload pButton"><span></span></div> </div> <div class="btnseparator"></div> <div class="pGroup"><span class="pPageStat"></span></div>';
...
//		$(g.pDiv,g.totalDiv).append("<div style='clear:both'></div>");
		...
		if (p.filter)
		{
			if(p.appendFilter){
				...
				+ '<input type="submit" value="Search" id="btnSearch" class="quickSearch"></input>' + 
				'</span></div>'
				;
