...
<body >
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              <a class="nav-link" href="__URL__/index"><i class="fa fa-fw fa-home"></i><?php echo (L("home")); ?> <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
     ...
     var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#tradeList').bootstrapTable('destroy').bootstrapTable({
                url: '__URL__/getMailSetting',         //请求后台的URL（*）
                method: 'get',                      //请求方式（*）
               ...
               // height: 400,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
                ...
                columns: [{
                    title: "data-checkbox='true'"},
				  {
                    ...
                    field: 'setting_value',
                    title: "<?php echo (L("setting_value")); ?>",
					width:'60%',
                },{
                    field: 'remark',
                    title: "<?php echo (L("remark")); ?>",
					width:'25%',
                }/*, {
          field: 'operate',
          title: 'Action',
 ...
 $(function(){
   ...
   $("#menu-toggle").click(function(e) {
    ...
    add_recd=function(){ location.href ="__URL__/mail_add";}
    edit_recd=function(){
	     ...
	     if ($('#tradeList').bootstrapTable('getSelections').length==0)
	     {
		   ...
		   location.href ="__URL__/mail_edit/id/"+id;
		 }
	  ...
	  del_recd=function(){
	     ...
	     if ($('#tradeList').bootstrapTable('getSelections').length==0)
	     {
		   ...
		   var id=($('#tradeList').bootstrapTable('getSelections')[0].id);
		   location.href ="__URL__/mail_del/id/"+id;
		 }
	   
	   }
	  refresh_recd=function(){
	     $('#tradeList').bootstrapTable('refreshOptions', {
               url: '__URL__/getMailSetting'
             })	   
	   }
