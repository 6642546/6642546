			    ...
			    <div class="row" >
			     ...
			     <form action='__URL__/save' method='post' style='margin-top:0;' enctype="multipart/form-data" class="needs-validation" novalidate>
				      <div class="form-group row"  style='border-bottom:1px solid black; font-size:20px;'>
                       <input type="text" readonly class="form-control-plaintext" id="pcn_no" name='pcn_no' value="No.<?php echo ($pcn_no); ?>">
					  </div>
					  <div class="form-group row">
						<label for="internal_pn" class="col-sm-2 col-form-label-sm"><?php echo (L("internal_pn")); ?> :</label>
						<div class="col-sm-4">
					    <input type="text" class="form-control col-form-label-sm" id="internal_pn" name='internal_pn' placeholder="<?php echo (L("internal_pn")); ?>" style='width:85%;float:left' readonly required> 
						...
						<div class="col-sm-4">
						  <input type="text"  class="form-control col-form-label-sm" id="cust_pn" name='cust_pn' placeholder="<?php echo (L("cust_pn")); ?>"  readonly >				
						</div>
					  </div>
					   <div class="form-group row">
						<label for="cust_name" class="col-sm-2 col-form-label-sm"><?php echo (L("cust_name")); ?> :</label>
						<div class="col-sm-4">
						  <input type="text" class="form-control col-form-label-sm" id="cust_name" name='cust_name' placeholder="<?php echo (L("cust_name")); ?>" readonly>
						</div>
						<label for="initiator_dept" class="col-sm-2 col-form-label-sm"><?php echo (L("initiator_dept")); ?> :</label>
						<div class="col-sm-4">
						  <input type="text" class="form-control col-form-label-sm" id="initiator_dept" name='initiator_dept' value="<?php echo ($initiator_dept); ?>" placeholder="<?php echo (L("initiator_dept")); ?>" readonly>
						</div>
					  </div>
                    <div class="form-group row" style='border-top:1px solid black;border-bottom:1px solid balack;'>
							...
							<div class='col-sm-10' style='padding-top:20px;'>
									 <div class="form-group row">
										...
										<div class="col-sm-10">
										  <textarea class="form-control" id="before_change" placeholder="<?php echo (L("before_change")); ?>"  name='before_change' rows="6" required></textarea>
										   <div class="invalid-feedback">
										...
										<div class="col-sm-10" style='padding-top:10px;'>
										  <textarea class="form-control" id="after_change" placeholder="<?php echo (L("after_change")); ?>"  name='after_change' rows="6" required></textarea>
										   <div class="invalid-feedback">
	                ...
	                <div class="form-group row"  style='border-top:1px solid black;' >
							...
							<div class='col-sm-10'>
									 <div class="form-group row"  style='padding-top:20px;'>
										...
										<div class="col-sm-10">
										  <textarea class="form-control" id="reason_change" placeholder="<?php echo (L("reason_change")); ?>"  name='reason_change' rows="6" required></textarea>
										   <div class="invalid-feedback">
                     ...
                     <div class="form-group row" style='border-top:1px solid black;border-left:1px solid balack;'>
							...
							<div class='col-sm-10'>
									...
									<label for="affect_remark" class="col-form-label-sm"><?php echo (L("affect_remark")); ?> :</label>
					           	   	<input type="text" class="form-control col-form-label-sm" id="affect_remark" name='affect_remark' placeholder="<?php echo (L("affect_remark")); ?>">
					  ...
					  <div class="form-group row" style='border-top:1px solid black;border-left:1px solid balack;'>
							...
							<div class='col-sm-10' style='padding-top:20px;'>
									<select name="pre_m" id="pre_m" class="form-control col-form-label-sm" required>
										<option value="" selected><?php echo (L("please_choose")); ?></option>
										<?php if(is_array($mlist)): $i = 0; $__LIST__ = $mlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo['user_name']); ?>"><?php echo ($vo['user_name']); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
									</select>
							</div>
					   ...
					   <div class="form-group row" style='border-top:1px solid black;border-left:1px solid balack;'>
							...
							<div class='col-sm-10' style='padding-top:20px;'>
									<select name="category" id="category" class="form-control col-form-label-sm" required>
										...
										<?php if(is_array($pcntype)): foreach($pcntype as $key=>$vo): ?><option value="<?php echo ($vo); ?>"><?php echo ($vo); ?></option><?php endforeach; endif; ?>
