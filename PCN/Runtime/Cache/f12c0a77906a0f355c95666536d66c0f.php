...
<body >
    ...
    <!-- Sidebar -->
      <div class="bg-light border-right" id="sidebar-wrapper">
		  ...
		  <div class="list-group list-group-flush">
			<a href="#" class="list-group-item list-group-item-action bg-light list-group-item-light" onclick='action_pcn("PE")'><?php echo (L("pe_m")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("PRE")'><?php echo (L("pre_m")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("QA")'><?php echo (L("qa_m")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("ENGD")'><?php echo (L("eng_d")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("MFGD")'><?php echo (L("prod_d")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("QAD")'><?php echo (L("qa_d")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("SPCN")'><?php echo (L("spcn")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("CCOMP")'><?php echo (L("ccomp")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("PEE")'><?php echo (L("PEE")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("completion")'><?php echo (L("completion")); ?></a>
			<a href="#" class="list-group-item list-group-item-action bg-light" onclick='action_pcn("Reject")'><?php echo (L("reject")); ?></a>
          ...
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            ...
            <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
			    ...
			    <?php if( $_SESSION['admin'] == 'admin' ): ?><div class="dropdown-divider"></div>  
				    <a class="dropdown-item" href="__APP__/Admin/index"><?php echo (L("admin")); ?> </a><?php endif; ?>
               </div>
            </li>
          </ul>
        </div>
               ...
               // height: 400,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
                ...
                columns: [{
                    title: "data-checkbox='true'"},
				  {
                    ...
                    field: 'pcn_no',
                    title: "<?php echo (L("pcn_no")); ?>",
					width:'8%'
                }, {
                    field: 'cust_name',
                    title: "<?php echo (L("cust_name")); ?>"
                }, {
                    field: 'cust_pn',
                    title: "<?php echo (L("cust_pn")); ?>"
                }, {
                    field: 'initiator_dept',
                    title: "<?php echo (L("initiator_dept")); ?>"
                }, {
                    field: 'internal_pn',
                    title: "<?php echo (L("internal_pn")); ?>"
                }/*, {
                    field: 'before_change',
                    title: "<?php echo (L("before_change")); ?>"
                }, {
                    field: 'after_change',
                    title: "<?php echo (L("after_change")); ?>"
                }, {
                    field: 'reason_change',
                    title: "<?php echo (L("reason_change")); ?>"
                }*/, {
                    field: 'initiation_date',
                    title: "<?php echo (L("initiation_date")); ?>"
                }, {
                    field: 'curr_status',
                    title: "<?php echo (L("curr_status")); ?>",
 ...
 $(function(){
   ...
   $("#menu-toggle").click(function(e) {
    ...
    title: '<?php echo (L("advace_search")); ?>',
  /*  message:  '<div class="well" style="margin-top:10px;"><form class="form-horizontal" role="form"> '
   ...
   message:'<form>\
		  <div class="form-group row mb-2"> \
             <label for="s_pcn_no" class="col-sm-2 col-form-label col-form-label-sm"><?php echo (L("pcn_no")); ?>:</label>\
             <div class="col-sm-10">\
                 <input type="text" class="form-control form-control-sm" id="s_pcn_no" placeholder=<?php echo (L("pcn_no")); ?>>\
             </div>\
          </div>\
		  <div class="form-group row mb-2"> \
             <label for="s_cs_name" class="col-sm-2 col-form-label col-form-label-sm "><?php echo (L("cust_name")); ?>:</label>\
             <div class="col-sm-10">\
                 <input type="text" class="form-control form-control-sm" id="s_cs_name" placeholder=<?php echo (L("cust_name")); ?>>\
             </div>\
          </div>\
		  <div class="form-group row mb-2"> \
             <label for="s_cs_pn" class="col-sm-2 col-form-label col-form-label-sm"><?php echo (L("cust_pn")); ?>:</label>\
             <div class="col-sm-10">\
                 <input type="text" class="form-control form-control-sm" id="s_cs_pn" placeholder=<?php echo (L("cust_pn")); ?>>\
             </div>\
          </div>\
		  <div class="form-group row mb-2"> \
             <label for="s_internal_pn" class="col-sm-2 col-form-label col-form-label-sm"><?php echo (L("internal_pn")); ?>:</label>\
             <div class="col-sm-10">\
                 <input type="text" class="form-control form-control-sm" id="s_internal_pn" placeholder=<?php echo (L("internal_pn")); ?>>\
             </div>\
          </div>\
		   <div class="form-group row mb-2"> \
             <label for="s_internal_pn" class="col-sm-2 col-form-label col-form-label-sm"><?php echo (L("pcn_type")); ?>:</label>\
             <div class="col-sm-10">\
		    ...
		    <div class="form-group row ml-1">\
				<div class="form-check form-check-inline">\
				  ...
				  <label class="form-check-label col-form-label col-form-label-sm" for="inlineRadio1"><?php echo (L("excuted_pn")); ?></label>\
				</div>\
				<div class="form-check form-check-inline">\
				  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">\
				  <label class="form-check-label col-form-label col-form-label-sm" for="inlineRadio2"><?php echo (L("pending_executed_pn")); ?></label>\
				</div>\
				<div class="form-check form-check-inline">\
				  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3">\
				  <label class="form-check-label" for="inlineRadio3"><?php echo (L("pending_sending_cust")); ?></label>\
				</div>\
				<div class="form-check form-check-inline">\
				  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio4" value="option4">\
				  <label class="form-check-label" for="inlineRadio3"><?php echo (L("pending_cust_reply")); ?></label>\
				</div>\
				<div class="form-check form-check-inline">\
				  <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio5" value="option5">\
				  <label class="form-check-label" for="inlineRadio3"><?php echo (L("pcn_list")); ?></label>\
				</div>\
		  </div>\
        </form>',
    size: 'large',
