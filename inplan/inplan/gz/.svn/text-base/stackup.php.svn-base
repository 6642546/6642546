...
echo "<center><div class='header'>
		...
		<table width='100%'>
			<tr><td style='background: url($logo_dir/logo.gif) no-repeat;height:65px;'>&nbsp</td><td colspan=3 style='text-align:left;'><b style='padding-left:60px;'><font size=+2>Stackup Report</font></b></td></tr>
