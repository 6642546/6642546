...
$query = "select 
				...
				-- job_da.OSWF_ESPRAY_REQD_,
				 job_da.*,
				 job_db.*,
				 job.num_pcbs,
				 --job_da.PANEL_QUANTITY_,
				 part.pcb_size_x,
				 part.pcb_size_y,
				 part.NUM_PCBS_IN_ARRAY,
				 job_da. DRAWING_REF_ AW_REV_,
				 job_da.MARK_CUST_PART_REV_ BP_REV_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='LOGO_CODE_' and ev.enum=job_da.CI_LOGO_CODE_) as UL_CODE_,
			     (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='FINISH_SURFACE_' and ev.enum=job_da.FINISH_SURFACE_) as SURFACE_FINISH_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='SOLDER_MASK_TYPE_' and ev.enum=job_da.SOLDER_MASK_TYPE_) as SOLDERMASK_TYPE_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='SOLDER_MASK_COLOR_' and ev.enum=job_da.SOLDER_MASK_COLOR_) as SOLDERMASK_COLOR_,
				(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='SOLDER_MASK_TYPE_' and ev.enum=job_da.OSSM_2ND_SM_TYPE_) as OSSM_2ND_SM_TYPE_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='SOLDER_MASK_COLOR_' and ev.enum=job_da.OSSM_2ND_SM_INK_COLOR_) as OSSM_2ND_SM_INK_COLOR_,
				 --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 --		and et.type_name='LCM_INK_TYPES_' and ev.enum=job_da.LCM_INK_TYPES_) as LCM_INK_TYPES_,
				 job_da.LEGEND_ON_PAD_ LCM_INK_TYPES_,
				 job.NUM_ARRAYS,
				 ...
				 job_da.PLATING_SURFACE_THICKNESS_ SURFACE_FINISH_THK_MIN_,
				 --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 --		and et.type_name='SELECTIVE_PLATE_TYPE_' and ev.enum=job_da.SELECTIVE_PLATE_) as SELECTIVE_PLATE_,
				 job_da.FINISH_SURFACE_OTHER_ SELECTIVE_PLATE_,
				 --job_da.SELECTIVE_PLATE_THK_MIN_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='SIDE' and ev.enum=job_da.PLATING_GOLD_FINGER_SIDES_) as PLATED_TIPS_SIDES_,
				 --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 ...
				 job_da.PLATING_GOLD_FINGER_THICKNESS_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='COMPONENT_SIDES_' and ev.enum=job_da.PEELABLE_SIDE_) as SOLDERMASK_PEELABLE_SIDES_,
				 --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 ...
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='PEELABLE_TYPE_' and ev.enum=job_da.PEELABLE_TYPE_) as SOLDERMASK_PEELABLE_TYPE_,
			     --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 --		and et.type_name='JOB_STATUS_TYPE_' and ev.enum=job_da.ORDER_STATUS_) as ORDER_STATUS_,
				 --(select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
				 --		and et.type_name='MFG_CLASS_TYPE_' and ev.enum=job_da.IPC_CLASS3_) as MFG_CLASS_,
				 --decode(job_da.IPC_CLASS3_,1,'Class 3','Class 2') MFG_CLASS_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='MATERIAL_FAMILY' and ev.enum=job_da.CUST_REQ_FAMILY_) as REQD_FAMILY_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='VENDOR' and ev.enum=job_da.CUST_REQ_VENDOR_) as REQD_VENDOR_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='ESPRAY_TYPE_' and ev.enum=job_da.OSWF_ESPRAY_INK_MODEL_) as OSWF_ESPRAY_INK_MODEL_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='ESPRAY_COLOR_' and ev.enum=job_da.OSWF_ESPRAY_INK_COLOR_) as OSWF_ESPRAY_INK_COLOR_,	
				  (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='ESPRAY_TYPE_' and ev.enum=job_db.OSWF_SECOND_ESPRAY_INK_MODEL_) as OSWF_SECOND_ESPRAY_INK_MODEL_,
				 (select ev.value from enum_types et,enum_values ev where et.enum_type=ev.enum_type 
						and et.type_name='ESPRAY_COLOR_' and ev.enum=job_db.OSWF_SECOND_ESPRAY_INK_COLOR_) as OSWF_SECOND_ESPRAY_INK_COLOR_		                                                                             
				 
				 
			from items i,job,job_da,customer c1,customer c2,part,part_da,users,stackup,items istackup,job_db
			...
			and job.item_id=job_db.item_id
			and job.revision_id=job_db.revision_id
            ...
            and i.root_id=(select root_id from items where item_name='$job_name' and item_type=2)";
...
echo "<tr class='inplan_attri_tr'><td>".getLang('Sheet Size X',$lang)."</td><td class='inplan_attri_td'>".($row['SHEET_SIZE_X_'] / 1000)."\""."</td><td>".getLang('Sheet Size Y',$lang)."</td><td class='inplan_attri_td'>".($row['SHEET_SIZE_Y_'] / 1000)."\""."</td></tr>";
echo "<tr class='inplan_attri_tr'><td>".getLang('Num PCBs In PNL',$lang)."</td><td class='inplan_attri_td'>".$row['ERP_PARTS_PER_PANEL_']."</td><td>".getLang('Num Arrays In PNL',$lang)."</td><td class='inplan_attri_td'>".$row['ERP_PARTS_PER_PANEL_']/$row['ERP_UNIT_PER_ARRAY_']."</td></tr>";
echo "<tr class='inplan_attri_tr'><td>".getLang('Num PCBs In Array',$lang)."</td><td class='inplan_attri_td'>".$row['ERP_UNIT_PER_ARRAY_']."</td><td>".getLang('Num Panels In Sheet',$lang)."</td><td class='inplan_attri_td'>".$row['PNL_PER_SHEET_']."</td></tr>";
//Solder Mask Type
echo "<tr><td colspan=4 class='inplan_attri_hd'>".getLang('Ink Type',$lang)."<td></tr>";
if ($row['OSWF_ESPRAY_REQD_']==1){
        	echo "<tr class='inplan_attri_tr'><td>".getLang('E-Spray Coating',$lang)."</td><td class='inplan_attri_td'>".$row['OSWF_ESPRAY_INK_MODEL_']."</td><td>".getLang('E-Spray Coating Color',$lang)."</td><td class='inplan_attri_td'>".$row['SOLDERMASK_COLOR_']."</td></tr>";
   }
if ($row['OSWF_ESPRAY_REQD_']==1 && $row['OSWF_SECOND_ESPRAY_REQD_']==1){
    echo "<tr class='inplan_attri_tr'><td>".getLang('2nd E-Spray Coating',$lang)."</td><td class='inplan_attri_td'>".$row['OSWF_SECOND_ESPRAY_INK_MODEL_']."</td><td>".getLang('2nd E-Spray Coating Color',$lang)."</td><td class='inplan_attri_td'>".$row['OSWF_SECOND_ESPRAY_INK_COLOR_']."</td></tr>";
}
if ($row['OSWF_ESPRAY_REQD_']==0){
		...
		if ($row['OSSM_2ND_SM_REQD_']==1){
		   echo "<tr class='inplan_attri_tr'><td>".getLang('2nd Solder Mask Type',$lang)."</td><td class='inplan_attri_td'>".$row['OSSM_2ND_SM_TYPE_']."</td><td>".getLang('2nd Solder Mask Color',$lang)."</td><td class='inplan_attri_td'>".$row['OSSM_2ND_SM_INK_COLOR_']."</td></tr>";
		}
}
echo "<tr class='inplan_attri_tr'><td>".getLang('Legend Type',$lang)."</td><td class='inplan_attri_td'>".$row['LCM_INK_TYPES_']."</td><td class='inplan_attri_tr'>".getLang('Legend Color',$lang)."</td><td class='inplan_attri_td'></td></tr>";
...
echo "<tr class='inplan_attri_tr'><td>".getLang('Surface Finish',$lang)."</td><td class='inplan_attri_td'>".$row['SURFACE_FINISH_']."</td><td class='inplan_attri_tr'>".getLang('Min Surface Finish Thk',$lang)."</td><td class='inplan_attri_td'>".$row['SURFACE_FINISH_THK_MIN_']." um.</td></tr>";
echo "<tr class='inplan_attri_tr'><td>".getLang('Selective Plate',$lang)."</td><td class='inplan_attri_td'>".$row['SELECTIVE_PLATE_']."</td><td class='inplan_attri_tr'>".getLang('Min Selective Plate Thk',$lang)."</td><td class='inplan_attri_td'>".$row['SELECTIVE_PLATE_THK_MIN_']." um.</td></tr>";
...
echo "<tr class='inplan_attri_tr'><td>".getLang('Tip Type',$lang)."</td><td class='inplan_attri_td'>"."None"."</td><td class='inplan_attri_tr'>".getLang('Min Gold Tip Thickness',$lang)."</td><td class='inplan_attri_td'>"."0"." um.</td></tr>";
} else {
	...
	echo "<tr class='inplan_attri_tr'><td>".getLang('Tip Type',$lang)."</td><td class='inplan_attri_td'>".$row['PLATED_TIPS_TYPE_']."</td><td class='inplan_attri_tr'>".getLang('Min Gold Tip Thickness',$lang)."</td><td class='inplan_attri_td'>".$row['GOLD_TIP_THICKNESS_MIN_']." um.</td></tr>";
}
...
$query = "select i.item_name
			...
			,CLD.MIN_LINE_WIDTH_ LINE_MIN_
			,CLD.MIN_LINE_TO_LINE_ SPACE_MIN_
			,CLD.AR_CUST_VIA_JOINT_ AR_MIN_
		from items i
			,items ic
			,copper_layer cl
			,copper_layer_da cld
