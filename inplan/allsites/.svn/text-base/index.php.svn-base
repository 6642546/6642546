...
<?php
	if ($_GET['data'] =='Job Attributes'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' //src='inplan/allsites/showjobdata.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
	 echo "<div class='attrtab'>";
	 require "inplan/allsites/showjobdata.php";
	 echo "</div>";
	
	} else if ($_GET['data'] =='Job History'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' src='inplan/allsites/showjobhistory.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
	 echo "<div class='attrtab'>";
		require "inplan/allsites/showjobhistory.php";
		echo "</div>";
	} else if ($_GET['data'] =='Stackup'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' src='inplan/allsites/stackup.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
	 echo "<div class='attrtab'>";
		require "inplan/allsites/stackup.php";
		echo "</div>";
	} else if ($_GET['data'] =='Drill Table'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' src='inplan/allsites/drill.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
		echo "<div class='attrtab'>";
		require "inplan/allsites/drill.php";
		echo "</div>";
	} else if ($_GET['data'] =='Traveller Routing'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' //src='inplan/allsites/traveler.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
		echo "<div class='attrtab'>";
		require "inplan/allsites/traveler.php";
		echo "</div>";
	} else if ($_GET['data'] =='Cam Instruction'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' src='inplan/allsites/caminstructions.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
		echo "<div class='attrtab'>";
		require "inplan/allsites/caminstructions.php";
		echo "</div>";
	} else if ($_GET['data'] =='TQ'){
	 //echo "<div class='attrtab'><iframe id='frame_content' scrolling='no' frameborder='0' onload='this.height=100' //src='inplan/allsites/tq.php?site=$site&job_name=".$_GET['job_name'];
	 //if ($lang) echo "&lang=$lang";
	 //echo "' width='100%'></iframe></div>";
	 echo "<div class='attrtab'>";
		require "inplan/allsites/tq.php";
		echo "</div>";
	}
?>